...
public class ListExample {
	...
	public static void main(String[] args) {
		// ArrayList와 LinkedList는 사용양식 모두 List를 따름
		// 따라서, 교환이 가능함. 인터페이스 같은 구현체들은 사용법이 같음.
		// 제네릭 : 타입 안정화를 위해 객체 내부에 저장되는 타입을 일치시키는 방법
		// String만 저장할 수 있는 컬렉션
		// List<String> list = new ArrayList<>(); // 1.8부터는 생성자에 제네릭 표기
		...
		int idx = list.indexOf("Networ"); // 없는 자료 조회시 -1
		...
		list.clear();
		System.out.println(list); // list라는 박스는 남아 있음
		
		// list 내부 데이터가 전부 비어있는지 확인하는 메서드
